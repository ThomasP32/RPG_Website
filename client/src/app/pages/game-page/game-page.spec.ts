...
describe('GamePageComponent', () => {
    ...
    beforeEach(async () => {
        ...
        // const combatModalOpenSubject = new Subject<boolean>();
        // const opponentSubject = new Subject<Player>();
        ...
        const countdownSpy = jasmine.createSpyObj('CountdownService', [], { countdown$: new Subject<number>() });
