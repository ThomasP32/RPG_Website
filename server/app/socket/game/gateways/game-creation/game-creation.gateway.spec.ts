...
describe('GameGateway', () => {
    ...
    beforeEach(async () => {
        ...
        // Mock the server property in the GameGateway
        gateway['server'] = serverStub;

        // Stub the 'to' method on the server to return an object with an 'emit' method
    ...
    describe('handleStartGame', () => {
        it('should start the game and call addGame on GameCreationService', () => {
            const newGame: GameRoom = { id: '1234', hostSocketId: '', players: [] } as GameRoom;
    ...
    describe('handleJoinGame', () => {
        it('should add player to game and call addPlayerToGame on GameCreationService', () => {
            ...
            const updatedGame: GameRoom = { id: gameId, players: [player] } as GameRoom;
    ...
    describe('handleDisconnect', () => {
        ...
        it('should call handlePlayerDisconnect when the player is not the host', () => {
            const gameId = 'game-id';
            const updatedGame: GameRoom = { id: gameId, players: [] } as GameRoom;
            stub(socket, 'rooms').value(new Set([gameId, 'client-id']));
